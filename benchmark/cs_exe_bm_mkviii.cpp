...
int main() {
    try {
        ...
        benchmark.addProgram("c-primes-bitpacked-1e9", "D:/code/prime-shootout/build/dist/round-aux/c-primes-bitpacked-1e9.exe", "");
        benchmark.addProgram("c-primes-parallel-1e9", "D:/code/prime-shootout/build/dist/round-aux/c-primes-parallel-1e9.exe", "");
        benchmark.addProgram("r-primes-segment-sieve-1e9", "D:/code/prime-shootout/build/dist/round-aux/r-primes-segment-sieve-1e9.exe", "");
        benchmark.addProgram("r-primes-wheel-1e9", "D:/code/prime-shootout/build/dist/round-aux/r-primes-wheel-1e9.exe", "");
        benchmark.addProgram("c-primes-the-beast-1e9", "D:/code/prime-shootout/build/dist/round-aux/c-primes-the-beast-1e9.exe", "");
