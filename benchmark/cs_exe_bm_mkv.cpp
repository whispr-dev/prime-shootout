...
int main() {
    try {
        ...
        benchmark.addProgram("p-primes-smart-500", "D:/code/prime-shootout/build/dist/round-1/p-primes-smart.exe", "500");
        benchmark.addProgram("p-primes-smart-50k", "D:/code/prime-shootout/build/dist/round-1/p-primes-smart.exe", "50000");
        benchmark.addProgram("p-primes-smart-500k", "D:/code/prime-shootout/build/dist/round-1/p-primes-smart.exe", "500000");

        // Original implementations (assuming they don't take arguments)
        benchmark.addProgram("c-primes", "D:/code/prime-shootout/build/dist/round-1/c-primes.exe", "");
        benchmark.addProgram("c-primes-fast", "D:/code/prime-shootout/build/dist/round-1/c-primes-fast.exe", "");
        benchmark.addProgram("r-primes", "D:/code/prime-shootout/build/dist/round-1/r-primes.exe", "");
        benchmark.addProgram("r-primes-fast", "D:/code/prime-shootout/build/dist/round-1/r-primes-fast.exe", "");
        benchmark.addProgram("c-primes-gpetey", "D:/code/prime-shootout/build/dist/round-1/c-primes-gpetey.exe", "");
        benchmark.addProgram("c-primes-claude", "D:/code/prime-shootout/build/dist/round-1/c-primes-claude.exe", "");
        benchmark.addProgram("c-primes-grok", "D:/code/prime-shootout/build/dist/round-1/c-primes-grok.exe", "");
        benchmark.addProgram("c-primes-gemini", "D:/code/prime-shootout/build/dist/round-1/c-primes-gemini.exe", "");
